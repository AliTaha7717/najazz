...
{{--                                Show Order_offer--}}
    ...
    <tr>
        ...
        <td>{{$item->implemented	 == 0 ?'wating':'implemented'}}</td>
                                        <td><a class="btn btn-primary" href="{{route('order.edit',$item->id)}}" role="button">Edit</a></td>
                                        <td> <form action="{{route('order.destroy',$item->id)}}" method="post">
...
{{--@if($item->order->implemented==0 && $stute==0)--}}
{{--    <tr>--}}
{{--        <th scope="row"> {{$item->id}}</th>--}}
{{--        <td>{{$item->driver->name}}</td>--}}
{{--        <td>{{$item->driver->phone}}</td>--}}
{{--        <td>{{$item->order->owner->name}}</td>--}}
{{--        <td>{{$item->order->owner->phone}}</td>--}}


{{--        <td>{{ $item->price}}</td>--}}
{{--        <td>{{$item->order->implemented}}</td>--}}
